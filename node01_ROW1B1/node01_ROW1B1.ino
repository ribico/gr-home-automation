...
inline void DefineTypicals()
{
	...
	Set_Temperature(ROW1B1_HVAC_COLLECTOR_FLOW_TEMP);
	Set_Temperature(ROW1B1_HVAC_COLLECTOR_RETURN_TEMP);
	Set_Temperature(ROW1B1_HVAC_COLLECTOR_FLOOR_FLOW_TEMP);
	Set_Temperature(ROW1B1_HVAC_COLLECTOR_FLOOR_RETURN_TEMP);
	Set_Temperature(ROW1B1_HVAC_COLLECTOR_FANCOILS_FLOW_TEMP);
	Set_Temperature(ROW1B1_HVAC_COLLECTOR_FANCOILS_RETURN_TEMP);

	Set_Temperature(ROW1B1_HVAC_BOILER_FLOOR_FLOW_TEMP);
	Set_Temperature(ROW1B1_HVAC_BOILER_FLOOR_RETURN_TEMP);

	Set_Temperature(ROW1B1_HVAC_HP_FLOW_TEMP);
	Set_Temperature(ROW1B1_HVAC_HP_RETURN_TEMP);
...
inline void ProcessLogics()
{
	...
	grh_Logic_Temperature(ROW1B1_HVAC_COLLECTOR_FLOW_TEMP);
	grh_Logic_Temperature(ROW1B1_HVAC_COLLECTOR_RETURN_TEMP);
	grh_Logic_Temperature(ROW1B1_HVAC_COLLECTOR_FLOOR_FLOW_TEMP);
	grh_Logic_Temperature(ROW1B1_HVAC_COLLECTOR_FLOOR_RETURN_TEMP);
	grh_Logic_Temperature(ROW1B1_HVAC_COLLECTOR_FANCOILS_FLOW_TEMP);
	grh_Logic_Temperature(ROW1B1_HVAC_COLLECTOR_FANCOILS_RETURN_TEMP);

	grh_Logic_Temperature(ROW1B1_HVAC_BOILER_FLOOR_FLOW_TEMP);
	grh_Logic_Temperature(ROW1B1_HVAC_BOILER_FLOOR_RETURN_TEMP);

	grh_Logic_Temperature(ROW1B1_HVAC_HP_FLOW_TEMP);
	grh_Logic_Temperature(ROW1B1_HVAC_HP_RETURN_TEMP);
