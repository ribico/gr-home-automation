...
#define SETPOINT_TEMP_SANITARY_WATER_MIN 	40.0
#define SETPOINT_TEMP_SANITARY_WATER_MAX 	45.0

#define SETPOINT_TEMP_DEADBAND_SMALL	0.2	// °C

#define SETPOINT_UR_1				60.0
#define SETPOINT_UR_2				70.0
#define SETPOINT_UR_3				75.0
#define SETPOINT_UR_DEADBAND	3.0

#define AMBIENCE_SETPOINT_DEFAULT	19.0
...
#define DALLAS_TEMP_RESOLUTION  10
...
const DeviceAddress HVAC_FLOOR_FLOW_TEMP_ADDR = DALLAS_1_ADDRESS;
const DeviceAddress HVAC_FLOOR_RETURN_TEMP_ADDR = DALLAS_8_ADDRESS;
